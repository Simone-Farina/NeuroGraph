...
- [x] 23-02-PLAN.md — Strip tools from chat route, rewrite prompt, clean up ChatPanel (AGENT-01, AGENT-02)
...
- [x] 26-02-PLAN.md — Prompt length calibration, paragraph eval assertion, Bloom verification + worktree cleanup (CHAT-02, BLOOM-01)
...
- [x] 999.1-02-PLAN.md — MessageList keyword highlight rendering + promptfoo eval case updates + visual verification

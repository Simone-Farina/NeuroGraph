...
- [x] 9. Graph-aware chat context — pgvector RAG (depends: 6, 8)
  ...
  **What to do**:
  ...
  - **Note**: Replaced SM-2 with FSRS-6 algorithm (better spaced repetition) in implementation.
  ...
  **What to do**:
  - Implement FSRS-6 algorithm in `src/lib/ai/fsrs.ts` (replacing SM-2 plan):
    - `scheduleReview(crystal, rating)`:
      ...
      - Logic: Updates stability, difficulty, retrievability, state
    - Compute retrievability: `R = (1 + factor * t / S) ^ -w20`

...
export function ChatInput({
  ...
  // If disabled but NOT streaming, we are in a "submitting/loading" state
  const isSubmitting = disabled && !isStreaming;
        ...
        <div className="shrink-0">
          {isStreaming ? (
            <button
              type="button"
              onClick={onStop}
              className="rounded-lg border border-red-500/30 bg-red-500/10 p-2 text-red-400 transition-all hover:bg-red-500/20 hover:shadow-[0_0_15px_-3px_rgba(239,68,68,0.4)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neural-cyan"

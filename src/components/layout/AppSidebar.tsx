            ...
            <div key={conversation.id} className="group relative">
              ...
              {!isCollapsed && (
                <button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 p-1.5 text-neural-light/30 hover:text-red-400 transition-all focus:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 rounded-md"

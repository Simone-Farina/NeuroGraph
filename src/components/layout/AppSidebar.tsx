    ...
    >
      ...
      <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} p-4 h-14 border-b border-white/5`}>
        ...
        <button
          ...
          className="p-1.5 rounded-md text-neural-light/40 hover:text-neural-light hover:bg-white/5 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-neural-cyan/50"
      ...
      <div className="flex-1 flex flex-col min-h-0 mt-4 border-t border-white/5">
        <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'justify-between'} p-4`}>
          ...
          <button
            ...
            className={`flex items-center justify-center rounded-md border border-white/10 bg-white/5 text-xs font-medium text-neural-light/80 transition hover:bg-white/10 hover:text-neural-cyan hover:border-neural-cyan/30 focus:outline-none focus-visible:ring-2 focus-visible:ring-neural-cyan/50 ${
            ...
            <div key={conversation.id} className="group relative">
              ...
              {!isCollapsed && (
                <button
                  ...
                  className="absolute right-2 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 focus:opacity-100 p-1.5 text-neural-light/30 hover:text-red-400 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-red-400"
      ...
      <div className="p-4 border-t border-white/5">
        <div className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'}`}>
          ...
          <button
            onClick={startTour}
            className="p-2 rounded-md text-neural-light/40 hover:text-neural-cyan hover:bg-white/5 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-neural-cyan/50"
            title="Start Tour"
          ...
          <button
            onClick={signOut}
            className="p-2 rounded-md text-neural-light/40 hover:text-neural-light hover:bg-white/5 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-neural-cyan/50"
            title="Sign Out"
            aria-label="Sign Out"
          >

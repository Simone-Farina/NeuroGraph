  ...
  describe('conversationQueries', () => {
    describe('create', () => {
      ...
      it('should throw error on failure', async () => {
        ...
        await expect(conversationQueries.create(mockClient, 'user1', 'Test Chat')).rejects.toEqual({ message: 'DB Error' });
      });
    });
    ...
    describe('getByUserId', () => {
      ...
      it('should throw error on failure', async () => {
        ...
        await expect(conversationQueries.getByUserId(mockClient, 'user1')).rejects.toEqual({ message: 'DB Error' });
      });
    });
    ...
    describe('delete', () => {
      ...
      it('should throw error on failure', async () => {
        ...
        await expect(conversationQueries.delete(mockClient, '1')).rejects.toEqual({ message: 'DB Error' });
      });
    });
  });
});
